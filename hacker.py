...
class SubmissionHTMLParser(html.parser.HTMLParser):
...
def scrape_solution(contest_id, submission_id):
    # os.mkdir(contest_id)
    contest_uri = 'http://codeforces.com/contest/{}/submission/{}'.format(contest_id, submission_id)
...
if __name__ == '__main__':
    ...
    parser.add_argument('submission_id', help='Numerical ID of submission to scrape')
